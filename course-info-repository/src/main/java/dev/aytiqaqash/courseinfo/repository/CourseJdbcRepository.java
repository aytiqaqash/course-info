...
""";
    ...
    public void addNotes(String id, String notes) {
        try (Connection connection = dataSource.getConnection()) {
            ...
            throw new RepositoryException("Failed to add notes to course with id: " + id, sqlException);
        }
    }
    ...
    public List<Course> getAllCourses() {
        try (Connection connection = dataSource.getConnection()) {
            ...
            throw new RepositoryException("Failed to retrieve courses ", sqlException);
        }
    }
}
